...
#error Определено слишком много макросов
#endif
...
void main() {
	...
	try {
		...
		Dictionary::Instance d1 = Dictionary::Create("Преподаватель, и фамилия, и имя, и даже отчество, но тут не забудем о номере телефона", 5);
